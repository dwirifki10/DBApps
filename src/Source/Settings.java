...
public class Settings extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Masukan Nama Lengkap");
    ...
    private void Button3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Button3MouseClicked
        ...
        try{
            String A, B, C;
            A = UsernameA.getText().toLowerCase();
            B = PasswordA.getText();
            C = Password2A.getText();
            
            conn = Connections.getConnection();
            pst = conn.prepareStatement( "SELECT * FROM sign_in WHERE username = ? and password = ?");
            pst.setString(1, A);
            pst.setString(2, B);
            rs = pst.executeQuery();
            ...
            if(Local.equalsIgnoreCase("admin")){
            String SQL1 = 
            "UPDATE sign_in SET username = username ,password='" + C + "',name= name ,email = email, type=type WHERE username = '"+ A +"'";
            conn = Connections.getConnection();
