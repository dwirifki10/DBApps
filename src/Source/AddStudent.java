...
public class AddStudent extends javax.swing.JFrame {
    ...
    private void tables() throws ClassNotFoundException{
       ...
       while(rs.next()){
        model.addRow
        (new Object[]{numbers++, rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(10), rs.getString(12) });
       }
    ...
    private void initComponents() {
        ...
        PanelB.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(309, 210, 150, 30));
    ...
    private void SaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SaveMouseClicked
        ...
        if(nisn.equals("") || name.equals("") || dates.equals("") || gender.equals("") || parents.equals("") || hp.equals("") || school.equals("") || address.equals("")){
            ...
            String SQL = "INSERT INTO student VALUES "
             + "('" + nisn + "','" + name + "','" + dates + "','" + gender + "','" + parents + "','" + hp + "','" + school + "','" + address + "','" + "" + "','" + "" + "','" + "" + "','" + "" + "')";
        conn = Connections.getConnection();
        pst = conn.prepareStatement(SQL);
        pst.execute(SQL);
        new SaveData().show();
