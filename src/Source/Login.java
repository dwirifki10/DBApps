...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Panel.add(TextUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 130, 130, 20));
        ...
        Panel.add(UserIcon1, new org.netbeans.lib.awtextra.AbsoluteConstraints(327, 147, 34, -1));
        ...
        Panel.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(367, 195, 115, -1));
           ...
           Mistakes.setText("Item terpilih sedang dalam perkembangan");
            ...
            try{
                ...
                if(rs.next()){
                    ...
                    B = rs.getString("type");
                    C = rs.getString("name");
                    if(selection.equalsIgnoreCase("admin") && B.equalsIgnoreCase("admin")){
                        MenuAdmin MA = new MenuAdmin(C);
                        MA.show();
                        show(false);
                    }if(selection.equalsIgnoreCase("guru") && B.equalsIgnoreCase("guru")){
                        MenuTeacher MT = new MenuTeacher(C);
                        MT.show();
                        show(false);
                    }if(selection.equalsIgnoreCase("siswa") && B.equalsIgnoreCase("siswa")){
