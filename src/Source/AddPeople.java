...
public class AddPeople extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        PanelA.add(Searching, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 80, 160, 30));
        ...
        PanelB.add(Searching1, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 80, 160, 30));
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        // TODO add your handling code here:
        try {
            JasperPrint jp = JasperFillManager.fillReport(getClass().getResourceAsStream("Jasper/ReportStudents.jasper"), null, Connections.getConnection());
    ...
    private void jButton5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton5MouseClicked
        // TODO add your handling code here:
        try {
            JasperPrint jp = JasperFillManager.fillReport(getClass().getResourceAsStream("Jasper/ReportTeacher.jasper"), null, Connections.getConnection());
            JasperViewer.viewReport(jp, false);
        } catch (JRException ex) {
            Logger.getLogger(AddPeople.class.getName()).log(Level.SEVERE, null, ex);
